...
graph = {
	'A': {'B': 1, 'C': 4},sorted# Graph as an adjacency list with weights as values of the inner dictionary 	efficiently represent the graphFEF	'B': {'A': 1, 'C': 2, 'D': 5},WDWDWDD	'C': {'A': 4, 'B': 2, 'D': 1},	while priority_queue:DWDWDWWDWDWWDWV	WD	SWSSDWCSWSDDWSFF	FDFDFVFEFSDCESDDWDSW
	'B': {'A': 1, 'C': 2, 'D': 5},
